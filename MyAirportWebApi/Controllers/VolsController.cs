...
namespace MyAirportWebApi.Controllers
{
    ...
    public class VolsController : ControllerBase
    {
        ...
        // GET: api/Vols/5
        /// <summary>
        /// L'option bagages permet d'indiquer si l'on veut voir la liste des bageges du vol ou non
        /// si false bagaes = null 
        /// </summary>
        /// <param name="id"></param>
        /// <param name="bagages"> indique si l('on veut que la liste ds bagages soit inclus dans le résultat</param>
        /// <returns></returns>
        [HttpGet("{id}")]
